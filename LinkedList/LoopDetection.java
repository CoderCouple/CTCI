...
public class MyLinkedList {
	...
	public boolean hasIntersection(Node head1, Node head2) {
		...
		int shift = Math.abs(length1 - length2);
	...
	public Node loopDetection(Node head1, Node head2) {
		Node fast = head1;
		Node slow = head2;
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(ln.hasIntersection(l1.head, l1.head));
